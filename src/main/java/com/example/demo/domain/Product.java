...
public class Product implements Serializable {
    ...
    // Adjusted buyProduct function for inventory management
    public boolean buyProduct() {
        if (this.inv > 0) {  // Ensures there's at least one item to purchase
            this.inv--;
            return true;  // Successful purchase
        }
        return false;  // Unsuccessful purchase due to no inventory
    }
}
