...
// make the add and remove buttons work
 ...
 //        return "confirmationassocpart";
    ...
    public String buyProduct(@RequestParam("productID") int theId, Model theModel ) {
        ...
        if (product != null && product.buyProduct()) {  // Checks if the product exists and can be purchased
            productService.save(product);
            return "confirmationbuyproduct";  // Redirect to a confirmation page
        }

        return "productbuyingerror";  // Redirect to an error page
    }
}
