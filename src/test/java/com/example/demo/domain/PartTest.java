...
class PartTest {
    ...
    void getMinimum() {
        ...
        assertEquals(minimum, partIn.getMinimum(), "Inhouse part minimum should match set value");

        partOut.setMinimum(minimum);
        assertEquals(minimum, partOut.getMinimum(), "Outsourced part minimum should match set value");
    }
    ...
    void getMaximum() {
        ...
        assertEquals(maximum, partIn.getMaximum(), "Inhouse part maximum should match set value");

        partOut.setMaximum(maximum);
        assertEquals(maximum, partOut.getMaximum(), "Outsourced part maximum should match set value");
    }
